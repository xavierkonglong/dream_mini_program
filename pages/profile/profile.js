...
Page({
  ...
  onShow() {
    ...
    if (this.data.isLoggedIn) {
      ...
      if (this.data.activeTab === 'diary' && this.data.dreamDiaryList.length === 0) {
  ...
  async loadDreamDiary() {
    try {
      ...
      const response = await http.get('/dream/posts/diary/my', {
        pageNum: 0,
        pageSize: 20
      }, {
        showLoading: false
  ...
  async loadCollection() {
    try {
      ...
      const response = await http.get('/dream/posts/my/favorites', {
        pageNum: 0,
        pageSize: 20
      }, {
        showLoading: false
  ...
  async loadLikes() {
    try {
      ...
      const response = await http.get('/dream/posts/my/likes', {
        pageNum: 0,
        pageSize: 20
      }, {
        showLoading: false
